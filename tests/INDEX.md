...
- `tests/test_subcommands.py` は、cmoc の主要サブコマンドと CLI 入口の決定論的な制御ロジックを検証する pytest テスト群の目次です。
...
- `INDEX.md` の自動生成やメンテナンス仕様そのものを調べたいとき。

## hash

- 848e69954def526c4da101b75e0510158ff25b4c446d9b2f1029cff65fd3af42
