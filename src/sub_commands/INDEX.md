...
- 各 oracle ファイルごとに `codex exec` を読み取り専用で呼び出し、JSON schema と意味制約を検査したうえで、評価結果を `.cmoc/reports/eval-oracles/<timestamp>.md` に保存します。
...
- fa83935cc77452862897e51b386196bb51e14716087e66703ddb1e4f2402ff8c
