...
- `src/commons` 配下の特定モジュール 1 つだけの詳細実装が必要なとき。
- `INDEX.md` の生成ルールそのものや、`oracles` の仕様断片だけを確認したいとき。
- テスト実装や画面設計だけを確認したいとき。

## hash

- 329079741b8c05908d93aa439c0a5b4d40fa6c4423519f9c59f5db2fc7a82683
