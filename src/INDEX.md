...
- `init.py` は初期化処理、`eval_oracles.py` は `review oracles` の評価処理、`apply/` と `session/` はそれぞれ apply 系と session 系の本体実装への入口です。
...
- 565669c6c6cff360c8bc3f67597eca1d949533983794caddcc7b6f22f024c8a7
