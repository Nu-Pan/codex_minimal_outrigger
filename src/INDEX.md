...
- 個別サブコマンドの引数、状態遷移、業務ロジックだけを追いたいときは対象外です。
- アプリ固有の機能や個別の実装モジュールを確認したいときは、そちらを読むべきです。
- テストや外部仕様の本文だけを探しているときは、この共通基盤より該当モジュールを直接読むべきです。

## hash

- 5034a27d76c7dead23810632a197bccd44ddd14a1541d3782f304fa99875ddf7
